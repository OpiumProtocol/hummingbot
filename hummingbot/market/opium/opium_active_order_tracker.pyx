...
OpiumOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class OpiumActiveOrderTracker:
    def __init__(self,
                 active_asks: OpiumOrderBookTrackingDictionary = None,
                 active_bids: OpiumOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> OpiumOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> OpiumOrderBookTrackingDictionary:
